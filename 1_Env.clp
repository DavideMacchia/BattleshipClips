...
=>
	(printout log-file "(num_fire_ok:"?fok") (num_guess_ok:"?gok") (num_sink:"?sink") (num_fire_ko:"?fko") (num_guess_ko:"?gko") (num_safe:"?saf")" crlf)
	(printout log-file "Your score is " (scoring ?fok ?fko ?gok ?gko ?saf ?sink) crlf)
